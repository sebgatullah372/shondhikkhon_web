...
Route::group(['middleware'=> ['auth']], function(){
    ...
    //===================================About Routes==================================================
    Route::resource('/about', 'AboutController', ['names'=> 'about'])->only(['index', 'edit', 'update']);
    //============================================================================================================
    ...
    Route::resource('/site-settings', 'SiteSettingController', ['names'=> 'site_settings'])->only(['index', 'edit', 'update']);
    //==========================================================================================================
