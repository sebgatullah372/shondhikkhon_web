                    ...
                    <div class="col-sm-10">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span> <b>Total Number of Galleries:</b> {{$galleries->count()}}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                    </div>
                ...
                <div class="row">
                    @foreach($galleries as $gallery)
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <h6 class="text-center pt-1">{{$gallery->album->name}}</h6>
                                <img class="card-img-top cover-image" src="{{asset($gallery->cover_photo)}}"
                                     alt="Card image cap">
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <div class="float-right">
                                        <a href="{{route('galleries.show', $gallery->id)}}" class="btn btn-success">View</a>
        ...
        <div class="modal fade" id="galleryCreateModal">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <!-- form start -->
                    <form role="form" id="galleryCreateForm" action="{{route('galleries.store')}}"
                          method="post"
